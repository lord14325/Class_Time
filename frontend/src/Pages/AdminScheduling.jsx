...
const Schedule = () => {
    ...
    const generateSemesterWeeks = () => {
        const weeks = [];
        const semesterStart = selectedSemester.includes('2024') ? new Date('2024-09-01') : new Date('2025-01-01');
        const semesterEnd = selectedSemester.includes('2024') ? new Date('2025-06-30') : new Date('2025-12-31');
        let currentWeek = new Date(semesterStart);
        currentWeek.setDate(currentWeek.getDate() - currentWeek.getDay() + 1);
        while (currentWeek <= semesterEnd) {
            ...
            <div className="personal-schedule-container">
                ...
                {timeSlotsList.length === 0 ? (
                    ...
                    <div id="personal-schedule-export">
                        <div className="schedule-user-info" style={{
                            padding: '20px', marginBottom: '20px', backgroundColor: '#f8f9fa',
                            ...
                            {bulkScheduleDays.map(day => {
                                ...
                                return (
                                    <div key={day} className="schedule-cell bulk-cell">
                                        ...
                                        {selectedCourse && (
                                            <div className="course-info" style={{ fontSize: '11px', marginTop: '3px' }}>
            ...
            <div className="admin-scheduling-container">
                <div className="scheduling-controls">
                    ...
                    <div className="control-group">
                        ...
                        <input type="date" value={selectedWeekStart} onChange={(e) => setSelectedWeekStart(e.target.value)} className="week-select" />
                    </div>
                ...
                {schedulingMode === 'single-day' && hasConflicts && (
                    <div className="conflict-message-top">⚠️ Scheduling conflicts detected. Please review highlighted cells.</div>
                )}
                                        ...
                                        {semesters.map(semester => (
                                            <div key={semester.id || semester.value} className="semester-item">
                                                <div className="semester-info">
                                                    ...
                                                    {semester.start_date && (
                                                        <span className="semester-dates">{semester.start_date} to {semester.end_date}</span>
                                                    )}
                                                </div>
                                                {semester.id && (
